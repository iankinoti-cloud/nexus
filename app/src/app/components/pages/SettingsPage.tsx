...
function FormField({ label, type = 'text', value, placeholder }: {
  ...
  return (
    <div className="flex flex-col gap-1.5">
      <label style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))', fontWeight: 500 }}>{label}</label>
      <input
        type={type}
        value={val}
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        ...
        >
          <span style={{ color, fontSize: 'calc(14px * var(--fs))', fontWeight: 700 }}>{name[0]}</span>
        </div>
        <div>
          <div style={{ color: 'var(--text)', fontSize: 'calc(13px * var(--fs))', fontWeight: 500 }}>{name}</div>
          <div style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))' }}>{description}</div>
        </div>
      </div>
      <button
...
function ProfileTab() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 style={{ color: 'var(--text)', fontSize: 'calc(16px * var(--fs))', fontWeight: 600, marginBottom: 4 }}>Profile</h2>
        <p style={{ color: 'var(--text-dim)', fontSize: 'calc(13px * var(--fs))' }}>Manage your personal information and preferences.</p>
      </div>
      ...
      <div className="flex items-center gap-5">
        ...
        <div>
          <div style={{ color: 'var(--text)', fontSize: 'calc(15px * var(--fs))', fontWeight: 600 }}>{displayName}</div>
          <div style={{ color: 'var(--text-dim)', fontSize: 'calc(13px * var(--fs))' }}>
...
function OrganizationTab() {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 style={{ color: 'var(--text)', fontSize: 'calc(16px * var(--fs))', fontWeight: 600, marginBottom: 4 }}>Organization</h2>
        <p style={{ color: 'var(--text-dim)', fontSize: 'calc(13px * var(--fs))' }}>Configure your workspace and team settings.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div>
        <label style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))', fontWeight: 500, display: 'block', marginBottom: 6 }}>Fiscal Year Start</label>
...
function IntegrationsTab() {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 style={{ color: 'var(--text)', fontSize: 'calc(16px * var(--fs))', fontWeight: 600, marginBottom: 4 }}>Integrations</h2>
        <p style={{ color: 'var(--text-dim)', fontSize: 'calc(13px * var(--fs))' }}>Connect your tools and data sources with NEXUS.</p>
      </div>
...
function SecurityTab() {
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 style={{ color: 'var(--text)', fontSize: 'calc(16px * var(--fs))', fontWeight: 600, marginBottom: 4 }}>Security</h2>
        <p style={{ color: 'var(--text-dim)', fontSize: 'calc(13px * var(--fs))' }}>Manage authentication and access controls.</p>
      </div>
...
function AITab() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 style={{ color: 'var(--text)', fontSize: 'calc(16px * var(--fs))', fontWeight: 600, marginBottom: 4 }}>AI Preferences</h2>
        <p style={{ color: 'var(--text-dim)', fontSize: 'calc(13px * var(--fs))' }}>Configure how Core AI behaves and surfaces intelligence.</p>
      </div>
      <div
        className="rounded-xl p-5"
        style={{ background: 'var(--surface)', border: '1px solid var(--hair)' }}
      ...
      <div>
        <label style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))', fontWeight: 500, display: 'block', marginBottom: 8 }}>
          AI Confidence Threshold — {confidence}%
        </label>
        <p style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))', marginBottom: 12 }}>
          Core will only surface insights with confidence above this threshold.
        </p>
        <div className="flex items-center gap-3">
          <span style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))' }}>50%</span>
          <input
            type="range"
            min={50}
            max={95}
          ...
          />
          <span style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))' }}>95%</span>
        </div>
      </div>
      <div>
        <label style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))', fontWeight: 500, display: 'block', marginBottom: 8 }}>Response Style</label>
        <div className="flex gap-2">
...
function ThemeTab() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 style={{ color: 'var(--text)', fontSize: 'calc(16px * var(--fs))', fontWeight: 600, marginBottom: 4 }}>Theme</h2>
        <p style={{ color: 'var(--text-dim)', fontSize: 'calc(13px * var(--fs))' }}>Personalize the NEXUS visual experience.</p>
      </div>

      {/* Color mode */}
      <div>
        <label style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))', fontWeight: 500, display: 'block', marginBottom: 10 }}>Color Mode</label>
          ...
          {MODES.map(m => {
            ...
            return (
              ...
              >
                ...
                />
                <span style={{ color: active ? 'var(--accent)' : 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))', fontWeight: active ? 600 : 400 }}>{m.label}</span>
              </motion.div>
            );
          })}
        </div>
      ...
      {/* Accent */}
      <div>
        <label style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))', fontWeight: 500, display: 'block', marginBottom: 10 }}>Accent Color</label>
        <div className="flex items-center gap-3">
          {ACCENTS.map(ac => {
        ...
        <p style={{ color: 'var(--text-dim)', fontSize: 'calc(11px * var(--fs))', marginTop: 10, opacity: 0.7 }}>
      ...
      {/* Font size */}
      <div>
        <label style={{ color: 'var(--text-dim)', fontSize: 'calc(12px * var(--fs))', fontWeight: 500, display: 'block', marginBottom: 8 }}>Font Size</label>
        <div className="flex gap-2">
...
function WorkspaceTab() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h2 style={{ color: 'var(--text)', fontSize: 'calc(16px * var(--fs))', fontWeight: 600, marginBottom: 4 }}>Workspace Data</h2>
        <p style={{ color: 'var(--text-dim)', fontSize: 'calc(13px * var(--fs))' }}>Where your workspace lives, and how to start fresh.</p>
      </div>
      ...
      <div>
        ...
        {activity.length === 0 ? (
          <p style={{ color: 'var(--text-dim)', fontSize: 'calc(13px * var(--fs))', opacity: 0.7 }}>None yet — the workspace is in its original showroom state.</p>
        ) : (
          <div className="flex flex-col gap-1.5">
            {activity.slice(0, 6).map(a => (
              <div key={a.id} className="flex items-center gap-2" style={{ color: 'var(--text-dim)', fontSize: 'calc(12.5px * var(--fs))' }}>
                <span className="rounded-full" style={{ width: 5, height: 5, background: 'var(--accent)' }} />
                {a.label}
                <span style={{ opacity: 0.5, fontSize: 'calc(11px * var(--fs))' }}>{a.timestamp}</span>
              </div>
            ))}
            {activity.length > 6 && (
              <span style={{ color: 'var(--text-dim)', fontSize: 'calc(11px * var(--fs))', opacity: 0.6 }}>+{activity.length - 6} more</span>
            )}
          </div>
        )}
      </div>
